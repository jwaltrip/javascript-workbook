/*
  ...
  Rubric:
  - Each correct problem (16)
  - ES6 Syntax (10)
  - Clean Pull Request (10)
...
// filter the nums array to only even numbers
// then use reduce to sum the values of the even array
...
const weatherStates = weather.reduce((result, weatherObj) => {
  ...
  if (weatherObj.weather_state_name && result.indexOf(weatherObj.weather_state_name) === -1) {
    result.push(weatherObj.weather_state_name);
  }
  return result;
}, []);
